"""
Blueprint Agent — Vercel serverless version.
Imports rag_engine and granite_client from the same api/ directory.
"""
import logging
...
6. Total Runway needed (months) for Seed stage
...
4. Launch strategy (soft launch to full launch milestones)
...
2. Top 5 relevant investors/funds to approach
...
6. Fundraising timeline and milestones
...
2. Why IBM Cloud / IBM watsonx services should be integrated
...
class BlueprintAgent:
    ...
    def generate_full_blueprint(self, idea: str) -> dict:
        ...
        return {"idea": idea, "raw_blueprint": raw_output, "sections": sections}
    ...
    def generate_section(self, idea: str, section_name: str) -> str:
        ...
        context_query = context_query_map.get(section_name, idea)
        context = self.rag.get_context_for_query(context_query, n_results=6)
